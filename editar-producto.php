...
<body>
    ...
    <main>
        <form method="POST" enctype="multipart/form-data" action="php/editar-producto.php" id="">
        <input hidden type="text" name="id" value="<?php echo $_COOKIE['id']?>">
        <!--<div class="container">-->
        <div class="row">
                ...
                <div class="row"> <!-- contenedor imagenes secundarias -->
                    ...
                    <div class="col s3 m3 l3">  
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="file" name="img1" value="<?php echo $_COOKIE['img1']?>" required>
                            </div>
                            </div>
                    </div>
                    <div class="col s3 m3 l3">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="file" name="img2" value="<?php echo $_COOKIE['img2']?>" required>
                            </div>
                            </div>
                    </div>
                    <div class="col s3 m3 l3">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="file" name="img3" value="<?php echo $_COOKIE['img3']?>" required>
                            </div>
                            </div>
                    </div>
                    <div class="col s3 m3 l3">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="file" name="img4" value="<?php echo $_COOKIE['img4']?>" required>
                            </div>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="col s12">
                        <div class="card-panel">
                            <div class="input-field">
                                <input value="<?php echo $_COOKIE['nombre'];?>" id="nombre" type="text" name="nombre" class="validate" required>
                                <label for="nombre">Nombre Del Producto</label>
                            </div>
                            <div class="input-field">
                                <textarea name="descripcion" id="descripcion" class="materialize-textarea" required><?php echo $_COOKIE['descripcion'];?></textarea>
                            <label for="descripcion">Textarea</label>
                            </div>
                            <div class="input-field">
                                <input value="<?php echo $_COOKIE['precio'];?>" id="precio" type="text" name="precio" class="validate" required>
                                <label for="precio">Precio</label>
                            </div>
                            <div class="input-field">
                                <input value="<?php echo $_COOKIE['cantidad'];?>" id="cantidad" type="text" name="cantidad" class="validate" required>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <button class="col s12 center-align waves-effect waves-light btn"type="submit">Editar</button>
                                    </div>
                                </div>
                        </div> <!-- fin card-panel -->
                    </div>
